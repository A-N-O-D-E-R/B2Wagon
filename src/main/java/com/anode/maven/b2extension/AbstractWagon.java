...
/**
 * Abstract base implementation of the Maven Wagon interface.
 * Provides common boilerplate for wagon implementations.
 */
abstract class AbstractWagon implements Wagon {
    ...
    public void openConnection() {
        throw new RuntimeException("Never call openConnection directly");
    }
